...
public class PriceDialogWishlist extends DialogFragment implements PriceDialogAdapter.DialogInterface {
    private AreaDialogBinding binding;
    private Context context;
    private PriceDialogWishlist.SelectPriceInterface mInterface;
    private List<WishlistDetail> mProductList;
    private int position;

    public PriceDialogWishlist(Context context, SelectPriceInterface mInterface, List<WishlistDetail> mProductList, int position) {
    ...
    public void dialogCallback(int pricePosition, PriceDetail mPriceDetail) {
        ...
        mInterface.selectPriceCallback(mProductList, mPriceDetail, mProductList.get(position).getProductId());
        dismiss();
    }

    public interface SelectPriceInterface {
        void selectPriceCallback(List<WishlistDetail> mProductList, PriceDetail mPriceDetail, String productId);
    }
