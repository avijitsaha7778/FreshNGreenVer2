...
public class RelatedProductListAdapter extends RecyclerView.Adapter<RelatedProductListAdapter.ViewHolder>{
    ...
    @NonNull
    @Override
    public RelatedProductListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.product_list_adapter_item,parent,false);
        return new RelatedProductListAdapter.ViewHolder(view);
    }
