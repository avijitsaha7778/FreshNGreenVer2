...
public class RemoveWishlistApi extends GenericRequestHandler<RemoveWishlistModel> {
    private static ApiInterface authService;
    private Context context;
    private FragmentActivity activity;
    private Map<String, RequestBody> bodyMap;

    public static RemoveWishlistApi createInstance(Map<String, RequestBody> bodyMap, Context context, FragmentActivity activity)
    {
        RemoveWishlistApi instance = new RemoveWishlistApi();
    ...
    protected Call<RemoveWishlistModel> makeRequest() {
        return authService.removeWistlist(bodyMap);
    }
}